...
VIDEO_RECONNECT_FAILED_READS = _get_int("VIDEO_RECONNECT_FAILED_READS", 30)
VIDEO_IDLE_SLEEP_SECONDS = float(os.getenv("VIDEO_IDLE_SLEEP_SECONDS", "0.005"))
# Keep the UDP FIFO modest. Large FIFOs can retain already-corrupted MPEG-TS data
# and increase recovery latency with the older FFmpeg bundled by OpenCV on Windows.
VIDEO_UDP_FIFO_SIZE = _get_int("VIDEO_UDP_FIFO_SIZE", 32_768)
